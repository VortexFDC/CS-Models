...
nc=nc_open('scratch.XmodelX/hlev/ta_short.nc')
...
nc=nc_open('scratch.XmodelX/hlev/ps_short.nc')
p1=ncvar_get(nc,'ps')
nc_close(nc)
...
system(paste('cdo -s -r copy -setvar,ps -selvar,ta -sellevidx,$(seq -s, 1 ',format(length(a)),') scratch.XmodelX/hlev/ta_short.nc scratch.XmodelX/hlev/foo.pressure.nc',sep=''))
nc=nc_open('scratch.XmodelX/hlev/foo.pressure.nc',write=TRUE)
